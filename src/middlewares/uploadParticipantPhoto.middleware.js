...
const dest = path.join(__dirname, "..", "..", "uploads", "participants");
...
/** Champ fichier optionnel `photo` */
function uploadParticipantPhotoOptional(req, res, next) {
...
module.exports = uploadParticipantPhotoOptional;
